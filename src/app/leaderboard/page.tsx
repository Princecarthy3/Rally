            ...
            <>
              ...
              <section className="rounded-[28px] border-2 border-slate-950 bg-white p-6 shadow-[6px_6px_0_#171821]">
                <div className="flex items-center justify-between border-b-2 border-slate-100 pb-4 mb-4">
                  <h2 className="text-xl font-black">Global XP Rankings</h2>
                  <span className="text-xs font-bold text-slate-500">Ranked by total XP & Wins</span>
                </div>
                    ...
                    return (
                      <div
                        ...
                        className={`flex flex-wrap items-center justify-between gap-4 py-3.5 px-3 rounded-2xl transition ${
                          isMe ? "bg-violet-50 border-2 border-slate-950 shadow-[2px_2px_0_#171821]" : "hover:bg-slate-50"
                        }`}
                      >
                        ...
                        <div className="flex items-center gap-6">
                          <div className="text-right">
                            ...
                            <span className="text-[10px] font-bold text-slate-400">Level {item.level}</span>
                          </div>
                          ...
                          <div className="hidden sm:block text-right">
                            ...
                            <span className="text-[10px] font-bold text-slate-400">{item.games_played} Games</span>
                          </div>
                        </div>
                      </div>
                    );
...
function PodiumCard({
  ...
  return (
    ...
    >
      <span className="rounded-full border-2 border-slate-950 bg-white px-3 py-0.5 text-[10px] font-black uppercase shadow-sm">
        {titleBadge}
      </span>
      ...
      <NameDisplay
        ...
        className="mt-3 block text-lg font-black"
      />
      <p className="text-xs font-bold text-slate-700">[{user.customization?.title?.asset_value || "Challenger"}]</p>
      ...
      <div className="mt-4 border-t-2 border-slate-950/20 pt-3">
        ...
        <span className="text-xs font-black text-slate-700">Level {user.level} · {user.wins} Wins</span>
      </div>
    </div>
  );
}
