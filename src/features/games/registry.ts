export type GameKey = "uno" | "rps" | "number_guess" | "memory_match" | "mini_golf" | "battleship" | "tic_tac_toe" | "connect_four" | "dots_boxes" | "skribbl" | "ludo" | "basketball";
...
export const games: GameDefinition[] = [
  ...
  { key:"basketball", name:"Basketball", shortName:"Basketball", icon:"🏀", description:"iMessage-style hoops: pull back, release, and sink swishes with real arc physics.", players:"2", minPlayers:2, maxPlayers:2, color:"#fdba74", ink:"#7c2d12", tag:"Arcade" },
