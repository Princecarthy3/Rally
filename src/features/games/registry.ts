export type GameKey = "rps" | "number_guess" | "tic_tac_toe" | "dice_dash" | "quick_quiz" | "emoji_decode" | "dots_boxes" | "skribbl";
...
export const games: GameDefinition[] = [
  { key:"dice_dash", name:"Ludo Dice Dash", shortName:"Ludo Dash", icon:"🎲", description:"Classic Ludo board battle. Roll 6 to spawn tokens, capture opponents, and race home!", players:"2–4", minPlayers:2, maxPlayers:4, color:"#f4dc69", ink:"#4c3d00", tag:"Classic Ludo" },
