...
export const games: GameDefinition[] = [
  ...
  { key:"number_guess", name:"Number Hunt", shortName:"Number Hunt", icon:"📡", description:"Hide a signal on the 1–100 radar, then hunt it down with hot-and-cold scans before time runs out.", players:"2–4", minPlayers:2, maxPlayers:4, color:"#9fcaff", ink:"#123967", tag:"Signal Sprint" },
