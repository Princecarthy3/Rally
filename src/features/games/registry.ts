export type GameKey = "rps" | "number_guess" | "trivia_clash" | "memory_match" | "mini_golf" | "tic_tac_toe" | "connect_four" | "dots_boxes" | "skribbl" | "ludo";
...
export const games: GameDefinition[] = [
  ...
  { key:"mini_golf", name:"Mini Golf", shortName:"Mini Golf", icon:"⛳", description:"Pick your shot power, play nine holes, and finish with the lowest score.", players:"2–4", minPlayers:2, maxPlayers:4, color:"#b9f3b2", ink:"#14532d", tag:"New" },
