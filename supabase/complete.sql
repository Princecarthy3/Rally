...
alter table public.game_rooms add constraint game_rooms_game_type_check check (game_type in ('basketball','ping_pong','rps','number_guess','tic_tac_toe','dice_dash','quick_quiz','emoji_decode','dots_boxes','skribbl'));
